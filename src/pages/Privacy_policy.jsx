...
const Privacy_policy = () => {
  return (
    <div className="text-gray-700 container mx-2 lg:max-w-3xl xl:max-w-4xl lg:mx-auto mt-6 mb-20">
      ...
      <ul className="list-disc pl-5 mt-3">
        ...
        <li className="mt-2">
          <p>
            ...
            this Agreement) refers to Speaker Cleaner .
          </p>
        </li>
        <li className="mt-2">
          <p>
        ...
        <li className="mt-2">
          <p>
            <strong>Website</strong> refers to Speaker Cleaner , accessible from{" "}
            <a
              href="https://speakercleaner.io/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://speakercleaner.io/
            </a>
          </p>
        </li>
        <li className="mt-2">
      ...
      <p className="mt-6 font-semibold">Changes to this Privacy Policy</p>
      <p>
