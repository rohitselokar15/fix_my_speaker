    ...
    <div className="text-gray-700 container mx-2 lg:max-w-3xl xl:max-w-4xl lg:mx-auto mt-6 mb-20">
      ...
      <div className="">
        ...
        <p className="mt-3">
          ...
          use of Speaker Cleaner 's Website, located at speakercleaner.io.
        </p>

        <p className="mt-3">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Speaker cleaner if you do not agree
      ...
      <div className=" mt-10">
        ...
        <p className="mt-2">
          ...
          agreed to use cookies in agreement with the Speaker Cleaner 's Privacy
          Policy.{" "}
        </p>
      ...
      <div className="mt-10">
        ...
        <p className="mt-3">
          ...
          intellectual property rights for all material on Speaker cleaner . All
          intellectual property rights are reserved. You may access this from
          Speaker cleaner for your own personal use subjected to restrictions
        ...
        <ul className="list-disc  mt-3 pl-5">
          <li>Republish material from Speaker cleaner </li>
          <li>Sell, rent or sub-license material from Speaker cleaner </li>
          <li>Reproduce, duplicate or copy material from Speaker cleaner </li>
          <li>Redistribute content from Speaker cleaner </li>
        </ul>
        ...
        <p className="mt-3">
          ...
          Speaker Cleaner does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Speaker Cleaner ,its agents and/or affiliates.
          ...
          Speaker Cleaner shall not be liable for the Comments or for any
        ...
        <p className="mt-3">
          Speaker Cleaner reserves the right to monitor all Comments and to
        ...
        <p className="mt-3">
          You hereby grant Speaker Cleaner a non-exclusive license to use,
      ...
      <div className="mt-10">
        ...
        <p className="mt-3">
          ...
          the hyperlink compensates the absence of Speaker Cleaner ; and (d) the
        ...
        <p className="mt-3">
          ...
          sending an e-mail to Speaker Cleaner . Please include your name, your
        ...
        <p className="mt-3">
          No use of Speaker Cleaner 's logo or other artwork will be allowed for
